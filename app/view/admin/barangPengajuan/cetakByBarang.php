<body onload="window.print()">
    ...
    <div class=" rangkaSurat">
        ...
        <?php foreach ($data['filter'] as $pengajuanFilter) : ?>
        <?php endforeach; ?>

        <br>
        <h4 class="tengah"><b>Rekap Data Berdasarkan Barang Pengajuan : <?= $pengajuanFilter['pengajuan']; ?></b></h4>
        <br>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <?php foreach ($data['filter'] as $pengajuanFilter) : ?>
                    <tr>
                        <td><?= $i ?></td>
                        <td><?= $pengajuanFilter['id_pengajuan']; ?></td>
                        <td><?= $pengajuanFilter['pengajuan']; ?></td>
                        <td><?= $pengajuanFilter['alokasi']; ?></td>
                        <td><?= $pengajuanFilter['tanggal_pengajuan']; ?></td>
                        <td><?= $pengajuanFilter['status']; ?></td>
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
            </tbody>
