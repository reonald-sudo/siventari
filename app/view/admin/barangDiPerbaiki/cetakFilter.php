<body onload="window.print()">
    ...
    <div class=" rangkaSurat">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <?php $i = 1; ?>
                <?php foreach ($data['filter'] as $barangDiPerbaikiFilter) : ?>
                    <tr>
                        <td><?= $i ?></td>
                        <td><?= $barangDiPerbaikiFilter['barang']; ?></td>
                        <td><?= $barangDiPerbaikiFilter['alokasi']; ?></td>
                        <td><?= $barangDiPerbaikiFilter['toko_komputer']; ?></td>
                        <td><?= $barangDiPerbaikiFilter['tanggal_service']; ?></td>
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
            </tbody>
