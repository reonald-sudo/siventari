<body onload="window.print()">
    ...
    <div class=" rangkaSurat">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <?php $i = 1; ?>
                <?php foreach ($data['cetak'] as $cetakDataAllServiceCenter) : ?>
                    <tr>
                        <td><?= $i ?></td>
                        <td><?= $cetakDataAllServiceCenter['id_service_center']; ?></td>
                        <td><?= $cetakDataAllServiceCenter['service_center']; ?></td>
                        <td><?= $cetakDataAllServiceCenter['alamat']; ?></td>
                        <td><?= $cetakDataAllServiceCenter['no_telp']; ?></td>
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
            </tbody>
