<body onload="window.print()">
    ...
    <div class=" rangkaSurat">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <?php $i = 1; ?>
                <?php foreach ($data['cetak'] as $cetakDataAllSekertaris) : ?>
                    <tr>
                        <td><?= $i ?></td>
                        <td><?= $cetakDataAllSekertaris['id_pengajuan']; ?></td>
                        <td><?= $cetakDataAllSekertaris['barang']; ?></td>
                        <td><?= $cetakDataAllSekertaris['kondisi']; ?></td>
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
            </tbody>
