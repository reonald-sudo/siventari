<body onload="window.print()">
    ...
    <div class=" rangkaSurat">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <?php $i = 1; ?>
                <?php foreach ($data['cetak'] as $cetakDataAllDistributor) : ?>
                    <tr>
                        <td><?= $i ?></td>
                        <td><?= $cetakDataAllDistributor['id_distributor']; ?></td>
                        <td><?= $cetakDataAllDistributor['distributor']; ?></td>
                        <td><?= $cetakDataAllDistributor['alamat']; ?></td>
                        <td><?= $cetakDataAllDistributor['no_telp']; ?></td>
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
            </tbody>
