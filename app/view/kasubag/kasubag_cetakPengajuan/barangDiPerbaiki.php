    ...
    <div class=" rangkaSurat">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    <td>Januari</td>
                    <th><?= $data['hitungBarangDiPerbaikiJanuari']; ?></th>
                </tr>
            </tbody>
        </table>
            ...
            <tbody>
                ...
                <?php foreach ($data['cetakJanuari'] as $barangPengajuanCetakBerkala) : ?>
                    <tr>
                        ...
                        <td><?= $barangPengajuanCetakBerkala['tanggal_service']; ?></td>
                        <td><?= $barangPengajuanCetakBerkala['toko_komputer']; ?></td>
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
            </tbody>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    <td>Februari</td>
                    <th><?= $data['hitungBarangDiPerbaikiFebruari']; ?></th>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    <td>Maret</td>
                    <th><?= $data['hitungBarangDiPerbaikiMaret']; ?></th>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    <td>April</td>
                    <th><?= $data['hitungBarangDiPerbaikiApril']; ?></th>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    <td>Mei</td>
                    <th><?= $data['hitungBarangDiPerbaikiMei']; ?></th>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    <td>Juni</td>
                    <th><?= $data['hitungBarangDiPerbaikiJuni']; ?></th>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    <td>Juli</td>
                    <th><?= $data['hitungBarangDiPerbaikiJuli']; ?></th>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    <td>Agustus</td>
                    <th><?= $data['hitungBarangDiPerbaikiAgustus']; ?></th>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    <td>September</td>
                    <th><?= $data['hitungBarangDiPerbaikiSeptember']; ?></th>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    <td>Oktober</td>
                    <th><?= $data['hitungBarangDiPerbaikiOktober']; ?></th>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    <td>November</td>
                    <th><?= $data['hitungBarangDiPerbaikiNovember']; ?></th>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    <td>Desember</td>
                    <th><?= $data['hitungBarangDiPerbaikiDesember']; ?></th>
                </tr>
            </tbody>
        </table>
